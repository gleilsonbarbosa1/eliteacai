...
BEGIN
  -- Get sum of valid cashback with explicit casting
...
-- Create improved balance handling function with BEFORE trigger
...
-- Create trigger as BEFORE trigger to ensure balance is updated before transaction completes
...
-- Add comments
COMMENT ON FUNCTION get_available_balance IS 'Calculates available balance with proper decimal handling';
COMMENT ON FUNCTION handle_customer_balance IS 'Handles balance updates and validates redemptions with immediate balance updates';
