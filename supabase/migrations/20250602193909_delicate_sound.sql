/*
  # Fix cashback calculation and missing transactions

  1. Changes
    - Add function to calculate cashback (5% rate)
    - Generate missing cashback for existing purchases
    - Add trigger for automatic cashback calculation
    - Update balance handling to use cashback amounts
...
-- Create trigger for automatic cashback calculation
