/*
  # Fix cashback calculation to use 3% of purchase amount

  1. Changes
    - Update trigger function to ensure cashback is always 3% of purchase amount
    - Add validation to ensure cashback_amount is correct
    - Fix balance calculation to use only cashback amounts
...
COMMENT ON FUNCTION handle_customer_balance() IS 'Handles customer balance updates based on transaction changes. Ensures cashback is 3% of purchase amount and uses cashback_amount for balance calculations.';