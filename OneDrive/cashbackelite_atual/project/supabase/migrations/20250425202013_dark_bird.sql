...
-- Create trigger as BEFORE trigger
...
-- Add comments
COMMENT ON FUNCTION get_available_balance IS 'Calculates available balance with proper decimal handling and row locking';
